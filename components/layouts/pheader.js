                                        ...
                                        <ul className="menu-subnav">
                                                    ...
                                                    <ul className="menu-subnav">
                                                        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                            ...
                                                            <div className="menu-submenu">
                                                                ...
                                                                <ul className="menu-subnav">
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/school/dashboard.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Dashboard</span>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/school/statistics.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/school/calendar.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/school/library.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/school/teachers.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/school/students.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                        ...
                                                        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                            ...
                                                            <div className="menu-submenu">
                                                                ...
                                                                <ul className="menu-subnav">
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/student/dashboard.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Dashboard</span>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/student/profile.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Profile</span>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/student/calendar.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Calendar</span>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/apps/education/student/classmates.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Classmates</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/education/class/dashboard.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                            ...
                                            <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                ...
                                                <div className="menu-submenu">
                                                    ...
                                                    <ul className="menu-subnav">
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/dashboard.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/dashboard-2.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/dashboard-3.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/product-1.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Product 1</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/product-2.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Product 2</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/product-3.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Product 3</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/product-3.html" className="menu-link">
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/order-details.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/shopping-cart.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/apps/ecommerce/checkout.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                    ...
                                                    <ul className="menu-subnav">
                                                        ...
                                                        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                            ...
                                                            <div className="menu-submenu">
                                                                ...
                                                                <ul className="menu-subnav">
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/login-3/signup.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/login-3/signin.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/login-3/forgot.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                        ...
                                                        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                            ...
                                                            <div className="menu-submenu">
                                                                ...
                                                                <ul className="menu-subnav">
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/login-4/signup.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Sign Up</span>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/login-4/signin.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Sign In</span>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/login-4/forgot.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Forgot Password</span>
                                                        ...
                                                        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                            ...
                                                            <div className="menu-submenu">
                                                                ...
                                                                <ul className="menu-subnav">
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/classic/login-5.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                    ...
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="custom/pages/login/classic/login-6.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-dot">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">Login 6</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                ...
                                                <div className="menu-submenu">
                                                    ...
                                                    <ul className="menu-subnav">
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/pages/wizard/wizard-5.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Wizard 5</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/pages/wizard/wizard-6.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Wizard 6</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                ...
                                                <div className="menu-submenu">
                                                    ...
                                                    <ul className="menu-subnav">
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/pages/invoices/invoice-3.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Invoice 3</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/pages/invoices/invoice-4.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Invoice 4</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/pages/invoices/invoice-5.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Invoice 5</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="custom/pages/invoices/invoice-6.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">Invoice 6</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    ...
                                    <div className="menu-submenu">
                                        ...
                                        <ul className="menu-subnav">
                                            ...
                                            <li className="menu-item" aria-haspopup="true">
                                                <a href="layout/subheader/classic.html" className="menu-link">
                                                    <i className="menu-bullet menu-bullet-dot">
                                                        <span />
                                                    </i>
                                                    <span className="menu-text">Classic</span>
                                            ...
                                            <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                ...
                                                <div className="menu-submenu">
                                                    ...
                                                    <ul className="menu-subnav">
                                                        ...
                                                        <li className="menu-item" aria-haspopup="true">
                                                            <a href="crud/forms/widgets/jquery-mask.html" className="menu-link">
                                                                <i className="menu-bullet menu-bullet-dot">
                                                                    <span />
                                                                </i>
                                                                <span className="menu-text">jQuery Mask</span>
                                                            </a>
                                                        </li>
                                                        <li className="menu-item" aria-haspopup="true">
                                                    ...
                                                    <ul className="menu-subnav">
                                                        ...
                                                        <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                                            ...
                                                            <div className="menu-submenu">
                                                                ...
                                                                <ul className="menu-subnav">
                                                                    <li className="menu-item" aria-haspopup="true">
                                                                        <a href="crud/forms/editors/ckeditor-classic.html" className="menu-link">
                                                                            <i className="menu-bullet menu-bullet-line">
                                                                                <span />
                                                                            </i>
                                                                            <span className="menu-text">CKEditor Classic</span>
                                                                        </a>
                                                                    </li>
                                                                    <li className="menu-item" aria-haspopup="true">
                                ...
                                <li className="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    ...
                                    <div className="menu-submenu">
                                        ...
                                        <ul className="menu-subnav">
                                            ...
                                            <li className="menu-item" aria-haspopup="true">
                                                <a href="features/widgets/feeds.html" className="menu-link">
                                                    <i className="menu-bullet menu-bullet-dot">
                                                        <span />
                                                    </i>
                                            ...
                                            <li className="menu-item" aria-haspopup="true">
                                                <a href="features/widgets/nav-panels.html" className="menu-link">
                                                    <i className="menu-bullet menu-bullet-dot">
                                                        <span />
                                                    </i>
                                                            ...
                                                            <span className="svg-icon menu-icon">
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                                        ...
                                                                        <path d="M10,8 L8,8 L8,7 C8,5.34314575 9.34314575,4 11,4 L13,4 C14.6568542,4 16,5.34314575 16,7 L16,8 L14,8 L14,7 C14,6.44771525 13.5522847,6 13,6 L11,6 C10.4477153,6 10,6.44771525 10,7 L10,8 Z" fill="#000000" fillRule="nonzero" opacity="0.3" />
                                                                    </g>
                                                                </svg>
                                                                {/*end::Svg Icon*/}
                                                            </span>
                            ...
                            <div className="topbar">
                                ...
                                <div className="topbar-item">
                                    <div className="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                        ...
                                        <span className="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3" onClick={()=>{logout}}>Sean</span>
                                    ...
                                    <div className="col-lg-6 col-xxl-4">
                                        ...
                                        <div className="card card-custom card-stretch card-stretch-half gutter-b">
                                            ...
                                            <div className="card-body p-0">
                                                ...
                                                <div id="kt_stats_widget_11_chart" className="card-rounded-bottom" data-color="success" style={{ height: '150px' }} />
                                            </div>
                                            {/*end::Body*/}
                                        </div>
                                        {/*end::Stats Widget 11*/}
                                        ...
                                        <div className="card card-custom card-stretch card-stretch-half gutter-b">
                                            ...
                                            <div className="card-body p-0">
                                                ...
                                                <div id="kt_stats_widget_12_chart" className="card-rounded-bottom" data-color="primary" style={{ height: '150px' }} />
                                            </div>
                                            {/*end::Body*/}
                                        </div>
                                        {/*end::Stats Widget 12*/}
                                        ...
                                        <div className="card card-custom card-stretch gutter-b">
                                            ...
                                            <div className="card-body pt-2 pb-0 mt-n3">
                                                <div className="tab-content mt-5" id="myTabTables11">
                                                    {/*begin::Tap pane*/}
                                                    <div className="tab-pane fade" id="kt_tab_pane_11_1" role="tabpanel" aria-labelledby="kt_tab_pane_11_1">
                                                        {/*begin::Table*/}
                                                    ...
                                                    {/*end::Tap pane*/}
                                                    {/*begin::Tap pane*/}
                                                    <div className="tab-pane fade" id="kt_tab_pane_11_2" role="tabpanel" aria-labelledby="kt_tab_pane_11_2">
                                                        {/*begin::Table*/}
                                                        <div className="table-responsive">
                                                            <table className="table table-borderless table-vertical-center">
                                                                <thead>
                                            ...
                                            <div className="card-body pt-2">
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <label className="checkbox checkbox-lg checkbox-light-success checkbox-inline flex-shrink-0 m-0 mx-4">
                                                        <input type="checkbox" name="select" defaultValue={1} />
                                                        <span />
                                                    </label>
                                                    {/*end::Checkbox*/}
                                                    {/*begin::Text*/}
                                                ...
                                                <div className="d-flex align-items-center mt-10">
                                                    {/*begin::Bullet*/}
                                                    <span className="bullet bullet-bar bg-warning align-self-stretch" />
                                                    {/*end::Bullet*/}
                                                    {/*begin::Checkbox*/}
                                                    <label className="checkbox checkbox-lg checkbox-light-warning checkbox-inline flex-shrink-0 m-0 mx-4">
                                                        <input type="checkbox" defaultValue={1} />
                                                        <span />
                                                    </label>
                                                    {/*end::Checkbox*/}
                                                ...
                                                <div className="d-flex align-items-center mt-10">
                                                    {/*begin::Bullet*/}
                                                    <span className="bullet bullet-bar bg-info align-self-stretch" />
                                                    {/*end::Bullet*/}
                                                    {/*begin::Checkbox*/}
                                                    <label className="checkbox checkbox-lg checkbox-light-info checkbox-inline flex-shrink-0 m-0 mx-4">
                                                        <input type="checkbox" defaultValue={1} />
                                                        <span />
                                                    </label>
                                                    {/*end::Checkbox*/}
                                                ...
                                                <div className="d-flex align-items-center mt-10">
                                                    {/*begin::Bullet*/}
                                                    <span className="bullet bullet-bar bg-danger align-self-stretch" />
                                                    {/*end::Bullet*/}
                                                    {/*begin::Checkbox*/}
                                                    <label className="checkbox checkbox-lg checkbox-light-danger checkbox-inline flex-shrink-0 m-0 mx-4">
                                                        <input type="checkbox" defaultValue={1} />
                                                        <span />
                                                    </label>
                                                    {/*end::Checkbox:*/}
                                        ...
                                        <div className="card card-custom card-stretch gutter-b">
                                            ...
                                            <div className="card-body pt-0">
                                                ...
                                                <div className="mb-10">
                                                    ...
                                                    {/*end::Section*/}
                                                    {/*begin::Desc*/}
                                                    <p className="text-dark-50 m-0 pt-5 font-weight-normal">A brief write up about the Popular Authors that fits within this section</p>
                                                    {/*end::Desc*/}
                                                </div>
                                                {/*end::Item*/}
                                                {/*begin::Item*/}
                                                <div className>
                                                    ...
                                                    {/*end::Section*/}
                                                    {/*begin::Desc*/}
                                                    <p className="text-dark-50 m-0 pt-5 font-weight-normal">A brief write up about the New Users that fits within this section</p>
                                                    {/*end::Desc*/}
                                                </div>
                                                {/*end::Item*/}
                                            </div>
                                                        ...
                                                        <table className="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$23,000,000</span>
                                                                    ...
                                                                    <td>
                                                                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">Agoda</span>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$34,000,000</span>
                                                                        <span className="text-muted font-weight-bold">Paid</span>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">RoadGee</span>
                                                                        <span className="text-muted font-weight-bold">Paid</span>
                                                                    </td>
                                                                    <td>
                                                                        <img src="assets/media/logos/stars.png" alt="image" style={{ width: '5.5rem' }} />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td className="text-left pr-0">
                                                                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">$2,600,000</span>
                                                                        <span className="text-muted font-weight-bold">Paid</span>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">The Hill</span>
                    ...
                    <div className="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                        ...
                        <div className="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div className="text-dark order-2 order-md-1">
                                ...
                                <a className="text-dark-75 text-hover-primary">Keenthemes</a>
                            </div>
                            {/*end::Copyright*/}
                            {/*begin::Nav*/}
                            <div className="nav nav-dark">
                                <a className="nav-link pl-0 pr-5">About</a>
                                <a className="nav-link pl-0 pr-5">Team</a>
                                <a className="nav-link pl-0 pr-0">Contact</a>
                            </div>
                            {/*end::Nav*/}
                        </div>
                        {/*end::Container*/}
